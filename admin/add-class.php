...
if (isset($_SESSION['role']) && isset($_SESSION['admin_id']) && isset($_SESSION['admin_username'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO class (classname, section) VALUES (:classname, :section)";
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  name="section" class="form-control" required='true'>
                                                ...
                                                <option value="A">informatique</option>
                                                <option value="B">gestion</option>
                                                <option value="C">info-gestion</option>
                                            </select>
                                        </div>
