...
$sql="SELECT student.StuID,student.ID as sid,student.StudentName,student.StudentEmail,student.DateofAdmission,class.ClassName,class.Section from student join class on class.ID=student.StudentClass where student.StuID like '$sdata%' LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
