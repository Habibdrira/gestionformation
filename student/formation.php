                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex align-items-center mb-4">
                                    <h4 class="card-title mb-sm-0">Formateurs</h4>
                                ...
                                <div class="table-responsive border rounded p-1">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th class="font-weight-bold">Formation ID</th>
                                        ...
                                        <tbody>
                                            ...
                                            // Nombre total d'enregistrements
                                            $total_pages_sql = "SELECT COUNT(*) FROM formation ";
                                            $stmt = $dbh->prepare($total_pages_sql);
                                            $stmt->execute();
                                            $total_rows = $stmt->fetchColumn();
                                            $total_pages = ceil($total_rows / $no_of_records_per_page);
                                            ...
                                            // Récupération des données des formateurs
                                            $sql = "SELECT * FROM formation LIMIT $offset, $no_of_records_per_page";
                                            $query = $dbh->prepare($sql);
                                            $query->execute();
                                            $results = $query->fetchAll(PDO::FETCH_OBJ);
